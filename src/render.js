...
// ============================================================
// Renderiza la tarjeta de predicción con canvas
// ============================================================
...
// Ruta ABSOLUTA al archivo de estructura (sube 3 niveles desde utils/)
const estructuraPath = path.join(__dirname, '../../../predicciones/templates/estructura.js');
const { obtenerDiseno } = require(estructuraPath);
